                                ...
                                <div className="row">
                                    <div className="col-6">
                                        <div className="form-group">
                                            <label htmlFor="sponsorship">First Name*</label>
                                            <input type="text" className="form-control" placeholder="First Name" required />
                                        </div>
                                    </div>
                                    <div className="col-6">
                                        <div className="form-group">
                                            <label htmlFor="sponsorship">Last Name*</label>
                                    ...
                                    <div className="col-6">
                                        <div className="form-group">
                                            <label htmlFor="sponsorship">Email*</label>
                                            <input type="email" className="form-control" placeholder="Email" required />
                                        </div>
                                    </div>
                                    <div className="col-6">
                                        <div className="form-group">
                                            <label htmlFor="sponsorship">Phone Number*</label>
                                    ...
                                    <div className="col-12">
                                        <div className="form-group">
                                            <label htmlFor="sponsorship">Company Name</label>
                                    ...
                                    <div className="col-12">
                                        <div className="form-group">
                                            <label htmlFor="sponsorship">What type of budget range do you have at your disposal for sponsorable assets?</label>
                                            <input type="text" className="form-control" placeholder="Budget Range" />
                                        </div>
                                    </div>
                                    <div className="col-12">
