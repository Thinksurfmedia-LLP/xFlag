...
function DefensiveTable({ rows }: { rows: any[] }) {
...
export default function LeaderboardClient({
  ...
  return (
    <div className="states-table-main">
      <PassingTable rows={passingStats} />
      <ReceivingTable rows={receivingStats} />
      <RushingTable rows={rushingStats} />
      <DefensiveTable rows={defenseStats} />
    </div>
  );
}
