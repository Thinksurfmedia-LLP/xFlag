    ...
    <div>
      ...
      <div className="cms-card mt-5">
        <div className="cms-card-header">
          <div className="cms-card-title">
            <span className="cms-card-icon">🔗</span>
            <h5>Header Social Links</h5>
          </div>
          <button className="cms-btn cms-btn-outline" onClick={addSocialLink}>+ Add Link</button>
        </div>
        <div className="cms-card-body">
          <div className="cms-links-container">
            ...
            {(!data.socialLinks || data.socialLinks.length === 0) && (
              <p className="cms-empty-state-text">No header social links configured.</p>
            )}
          </div>
        </div>
      </div>
      ...
      <style>{`
        ...
        .cms-social-row { display: flex; gap: 12px; align-items: center; width: 100%; }
        .cms-social-row .cms-input { flex: 1; width: 100%; box-sizing: border-box; }
      `}</style>
    </div>
  );
}
